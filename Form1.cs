...
namespace SocialModelRebuild
{
    public partial class FormMain : Form
    {
        ...
        private void LocateElems()
        {
            ...
            this.panel1.Location = new Point(5, this.Height - 95);
        ...
        {
            this.FormGraph = new FormGraph(this.cellModel);
        ...
        private void buttonFirstIter_Click(object sender, EventArgs e)
        {
            ...
            {
                this.FormGraph.SetNewCellModel(this.cellModel);
            }
        ...
        {
            this.timerIteration.Stop();
            var saveForm = new FormSave(this.cellModel);
            saveForm.Show();
        }

        private void buttonLoad_Click(object sender, EventArgs e)
        {
            var loadForm = new FormLoad(this.cellModel);
            loadForm.Show();
            loadForm.ModelLoaded += (cellModel) =>
            {
                this.cellModel = cellModel;
                this.textBoxInfo.Text = cellModel.GetModelInfo();
            };
